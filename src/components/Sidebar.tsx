...
function Sidebar({ }: Props) {
  ...
  const { theme1, collapsed, collapseMenu } = useGlobalState();
  ...
  return (
    <Wrapper theme={theme1} collapsed={collapsed}
    className={`
      ${theme==='dark'?'bg-[#212121]':'bg-[#333343]'}
    `}
    >
      ...
      <div className="sign-out relative m-6 flex gap-6">
        <Button
          type={"submit"}
